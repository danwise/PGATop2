...
//                                    }
                                    ...
                                    .append($('<div/>',
                                        ...
                                        .append($('<h3/>',
                                        {
                                            'text': ($(this).find("Top4Score").text() == "" ? "" : $(this).find("Top4Score").text()) + "  " + $(this).find("GolfTeamName").text()
                                        }))
                                        .append($('<ul/>',
                                        {
                                            'id': 'Top4_' + $(this).find("GolfTeamId").first().text(),
                                            'data-role': 'listview',
                                            'data-inset': 'true'
                                    ...
                                    $(this).find("Golfer").each(
                                        function () {
                                            $('#Top4_' + $(this).find("GolfTeamId").first().text())
                                            .append($('<li/>', {})
                                             .append($('<a/>',
                                                {
                                                    'rel' : 'external',
                                        ...
                                        if ($(xml).find("TodaysRoundStarted").first().text() == "true") {
                                            ...
                                            if ($(xml).find("RoundInProgress").first().text() != "Rnd 1") {
                                                if ($(xml).find("TournamentRank").first().text() != "0")
                                                    rtn = "Rank: " + $(xml).find("TournamentRank").first().text();
                                                else {
                                                    if ($(xml).find("GolferScore").first().text() == 0)
                                                        if ($(xml).find("TodaysRoundStarted").first().text() == "true")
